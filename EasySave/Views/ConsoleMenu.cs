...
public class ConsoleMenu
{
    ...
    private void AddJob()
    {
        ...
        string source = Prompt(Translator.Get("Prompt_Source"), InputValidator.IsValidPath, Translator.Get("Error_InvalidPath"));
    ...
    private void ChangeLanguage()
    {
        ...
        Translator.SetLanguage(choice == "2" ? "fr" : "en");
    ...
    private static string Prompt(string prompt, Func<string, bool> validator, string errorMsg)
    {
        while (true)
        {
